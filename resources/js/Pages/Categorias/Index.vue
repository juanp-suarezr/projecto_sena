    ...
    <AuthenticatedLayout>
        ...
        <div class="inline-block min-w-full overflow-hidden mb-3 grid md:grid-cols-3 gap-4">
            ...
            <div class="text-right p-4">
                <PrimaryLink :href="route('categorias.create')">
                    Agregar
                </PrimaryLink>
            </div>
                ...
                <div class="inline-block min-w-full py-2">
                    <div class="overflow-x-auto">
                        <table class="min-w-full whitespace-no-wrap ">
                            ...
                            <tbody>
                                <tr v-for="categoria in categorias.data" :key="categoria.id" class="text-gray-700">
                                    <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
                                        <Avatar v-if="categoria.imagen != 'categoria.png'" :image="getImageUrl(categoria.imagen)"
                                            class="bg-amber-500 text-amber-800 text-xl" size="xlarge" shape="circle" />
                                        <Avatar v-else :label="getInitials(categoria.nombre)"
                                            class="bg-amber-500 text-amber-800 text-xl" size="xlarge" shape="circle" />
                                    </td>
                                    <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
